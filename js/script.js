...
function demarrerLaMontre() {
    ...
    secDeg = secDeg + 6; // mise à jour et ajout de 6° à chaque seconde 
    minDeg = minDeg + 0.1; // mise à jour et ajout de 0.1° à chaque seconde pour l'aiguille des minutes
    heureDeg = heureDeg + 0.00833; // mise à jour et ajout de 0.00833° à chaque seconde pour l'aiguille des heures
